...
`[Unverified]` iOS 27 / macOS 27 reportedly add a system-wide Liquid Glass intensity/transparency slider that lets users dial the effect back directly, independent of the existing Reduced Transparency toggle. If confirmed, design review should account for both the app-level `accessibilityReduceTransparency` fallback and this new user-controlled intensity range. See `whats-new-ios27.md`.
